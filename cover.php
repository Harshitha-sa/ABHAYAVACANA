...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/cal.png" width="30px" height="30px"><strong> ABHAYAVACANA </strong>Appointment Booking System</a></li>
					<li><a href="locateus.php">Locate Us</a></li>
					<li><a href="#home">Home</a></li>
				</ul>
			</div>
			<div class="center">
				<h1>ABHAYAVACANA Appointment Booking</h1><br>
...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate" action="signupappointment.php" method="post">
    <div class="imgcontainer">
